...
# @Filename : reproduce_results
# @Date : 05/19/2018 14:34:05
# @Poject : ceashpc-dvgcn
# @Author : FEI, hfut_jf@aliyun.com
# @Desc :

import origin.dvn.value_nets as value_nets
import origin.dvn.mlc_datasets as mlc_datasets
...
def run_bibtex():
    ...
    num_epochs=150
    net = value_nets.ValueNetwork('/network/rit/lab/ceashpc/fjie/tmp/dvn/bibtex_dvn',
